namespace CodexGame.Core.Shared
{
  public static class GameRules
  {
    ...
    public const long ThreeCallToSelectionPresentationMicroseconds = 10_000_000;
    public const float ShowdownFocusCompleteProgress = 0.10f;
    public const float ShowdownFirstCardRevealStartProgress = 0.08f;
    public const float ShowdownFirstCardRevealCompleteProgress = 0.17f;
    public const float ShowdownSecondCardRevealStartProgress = 0.16f;
    public const float ShowdownSecondCardRevealCompleteProgress = 0.24f;
    public const float ShowdownLabelRevealProgress = 0.20f;
