-- Compact, centered guide navigation for GitHub issue #63.
...
local C={
  ...
  leather=Color{r=28,g=19,b=14,a=255}, leather2=Color{r=43,g=28,b=18,a=255},
  brass0=Color{r=72,g=42,b=17,a=255}, brass1=Color{r=132,g=79,b=25,a=255},
  brass2=Color{r=205,g=139,b=43,a=255}, brass3=Color{r=244,g=192,b=81,a=255},
...
-- Compact center group rail and isolated close zone.
...
rail:saveAs(runtimeRoot.."/guide_nav_rail_960x104_0_5_6.png")

local plate=indicator(); plate:saveAs(runtimeRoot.."/guide_page_indicator_plate_132x38_0_5_6.png")
...
for _,kind in ipairs(kinds) do
  ...
  for _,state in ipairs(states) do
    ...
    b:saveAs(runtimeRoot.."/guide_nav_"..kind.."_"..state.."_56x58_0_5_6.png")
  end
end
...
preview:drawImage(plate,Point(indicatorX,461))
drawDots(preview,1,indicatorX+30,480)
preview:drawImage(generated.next.hover,Point(nextX,451))
preview:drawImage(generated.close.idle,Point(closeX,451))
preview:saveAs(previewRoot.."/guide_nav_compact_layout_preview_960x540_0_5_6.png")
...
for ki,kind in ipairs(kinds) do
  for si,state in ipairs(states) do
    local x=90+(ki-1)*300; local y=20+(si-1)*68
    sheet:drawImage(generated[kind][state],Point(x,y))
  end
end
sheet:saveAs(previewRoot.."/guide_nav_button_states_960x300_0_5_6.png")

local src=Sprite(960,104,ColorMode.RGB)
src.layers[1].name="guide_nav_compact_rail"
src.cels[1].image:drawImage(rail,Point(0,0))
src:saveAs(sourceRoot.."/guide_nav_rail_960x104_0_5_6.aseprite")
src:close()

local buttons=Sprite(56,58,ColorMode.RGB)
buttons.layers[1].name="previous_next_close_states"
...
buttons:saveAs(sourceRoot.."/guide_nav_button_states_56x58_0_5_6.aseprite")
buttons:close()
