...
source.layers[1].name = "stage_entry_poster_opponents_1_to_4"
...
for i,path in ipairs(inputs) do
  ...
  preview:saveAs(p.outputDir .. string.format("/stage_entry_opponent_%02d_poster_preview_960x540_0_1_2_4.png", i))
